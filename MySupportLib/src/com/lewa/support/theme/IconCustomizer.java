...
import com.lewa.support.graphics.BitmapInfo;
import com.lewa.support.graphics.IBitmapFilter;
import com.lewa.support.util.Constants;
import com.lewa.support.util.FileUtilities;
import com.lewa.support.util.ImageUtils;
import com.lewa.support.util.Shell;
//import libcore.io.Libcore;


import static com.lewa.support.util.Process.IS_SYSTEM;
import static com.lewa.support.util.Process.PACKAGE_NAME;
...
public class IconCustomizer {
    ...
    public static int sCustomizedIconWidth = Constants.CUSTOM_ICON_WIDTH; //Resources.getSystem().getDimensionPixelSize(lewa.R.dimen.custom_icon_size);
