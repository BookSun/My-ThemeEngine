...
import lewa.support.v7.internal.app.ToolbarActionBar;
import lewa.support.v7.internal.app.WindowCallback;
import lewa.support.v7.internal.app.WindowDecorActionBar;
...
import lewa.support.v7.internal.widget.DecorContentParent;
import lewa.support.v7.internal.widget.FitWindowsViewGroup;
import lewa.support.v7.internal.widget.ProgressBarCompat;
import lewa.support.v7.internal.widget.TintCheckBox;
import lewa.support.v7.internal.widget.TintCheckedTextView;
import lewa.support.v7.internal.widget.TintEditText;
import lewa.support.v7.internal.widget.TintRadioButton;
import lewa.support.v7.internal.widget.TintSpinner;
import lewa.support.v7.internal.widget.ViewStubCompat;
...
///LEWA ADD BEGIN FOR IMMERSIVE
    ...
    private  LewaActionBarContainer split_action_bar;
    ...
    final void ensureSubDecor() {
        if (!mSubDecorInstalled) {
            if (mHasActionBar) {
                ...
                split_action_bar = (LewaActionBarContainer)mSubDecor
		 ...
		 boolean handleActionMenuBack(boolean isActionMode) {
            ...
            if (isActionMode) {
                ...
                if (actionMenuView != null) {
                    ...
                    if (lewaActionBarContainer.isActionModeOptionMenuVisible()) {
                        if (isDown) {
                            toggleActionModeOptionMenu();
                        }
            	...
            	if (actionMenuView != null) { 
            		 ...
            		 LewaActionBarContainer lewaActionBarContainer = (LewaActionBarContainer) actionMenuView;
                     if (lewaActionBarContainer.isActionOptionMenuVisible()) {
                         if (isDown) {
