...
import lewa.support.v7.internal.view.SupportActionModeWrapper;
import lewa.support.v7.internal.widget.NativeActionModeAwareLayout;
...
class ActionBarActivityDelegateHC extends ActionBarActivityDelegateBase
    ...
    public ActionMode startActionModeForChild(View originalView, ActionMode.Callback callback) {
        ...
        final lewa.support.v7.view.ActionMode supportActionMode = startSupportActionMode(
