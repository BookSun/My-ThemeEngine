 ...
 * {@link lewa.support.v7.internal.app.WindowDecorActionBar WindowDecorActionBar} can behave
 * in the same way.</p>
 *
 * @hide
 */
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        if (mActionMenuPresenter == null) {
		    ///LEWA BEGIN
            mActionMenuPresenter = new LewaActionMenuPresenter(mToolbar.getContext());
			///LEWA END
...
////                    if (mToolbar.getParent() instanceof LewaActionBarContainer) {
////                        LewaActionBarContainer toolBarContainer = (LewaActionBarContainer) mToolbar.getParent();
