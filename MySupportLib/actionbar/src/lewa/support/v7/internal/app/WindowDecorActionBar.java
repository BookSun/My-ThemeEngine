...
package lewa.support.v7.internal.app;
/// LEWA ADD BEGIN
...
import lewa.support.v7.lewa.v5.LewaActionBarContextView;
/// LEWA ADD END
...
import lewa.support.v7.internal.view.ViewPropertyAnimatorCompatSet;
import lewa.support.v7.internal.view.SupportMenuInflater;
import lewa.support.v7.internal.view.menu.MenuBuilder;
import lewa.support.v7.internal.view.menu.MenuPopupHelper;
...
///LEWA END
    ...
    private void init(View decor) {
		...
		///LEWA  BEGIN
        mContextView = (LewaActionBarContextView) decor.findViewById(R.id.action_context_bar);
		///LEWA  END
...
///LEWA BEGIN
    ...
    */
    ...
    public boolean isActionOptionMenuVisible() {
        ...
        View vActionOptionMenu = null;//mSplitView.findViewById(com.lewa.internal.R.id.ll_action_option_menubar);
