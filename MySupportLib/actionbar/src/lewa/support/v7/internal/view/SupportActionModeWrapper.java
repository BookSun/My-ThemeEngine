...
public class SupportActionModeWrapper extends ActionMode {
    ...
    final lewa.support.v7.view.ActionMode mWrappedObject;

    public SupportActionModeWrapper(Context context,
            lewa.support.v7.view.ActionMode supportActionMode) {
     ...
     * @hide
     */
    public static class CallbackWrapper implements lewa.support.v7.view.ActionMode.Callback {
        final Callback mWrappedCallback;
        final Context mContext;

        final SimpleArrayMap<lewa.support.v7.view.ActionMode, SupportActionModeWrapper>
                mActionModes;
        ...
        @Override
        public boolean onCreateActionMode(lewa.support.v7.view.ActionMode mode, Menu menu) {
            return mWrappedCallback.onCreateActionMode(getActionModeWrapper(mode),
                    MenuWrapperFactory.createMenuWrapper(menu));
        }

        @Override
        public boolean onPrepareActionMode(lewa.support.v7.view.ActionMode mode, Menu menu) {
            return mWrappedCallback.onPrepareActionMode(getActionModeWrapper(mode),
                    MenuWrapperFactory.createMenuWrapper(menu));
        }

        @Override
        public boolean onActionItemClicked(lewa.support.v7.view.ActionMode mode,
        ...
        @Override
        public void onDestroyActionMode(lewa.support.v7.view.ActionMode mode) {
            mWrappedCallback.onDestroyActionMode(getActionModeWrapper(mode));
        }

        private ActionMode getActionModeWrapper(lewa.support.v7.view.ActionMode mode) {
