...
package lewa.support.v7.widget;
...
import lewa.support.v7.internal.widget.DecorToolbar;
import lewa.support.v7.internal.widget.RtlSpacingHelper;
import lewa.support.v7.internal.widget.TintManager;
import lewa.support.v7.internal.widget.TintTypedArray;
import lewa.support.v7.internal.widget.ToolbarWidgetWrapper;
...
import lewa.support.v7.lewa.v5.LewaActionMenuView;
 ...
 * using the {@link lewa.support.v7.app.ActionBarActivity#setSupportActionBar(Toolbar)
...
//    private InjectorTouchListener mInjectorTouchListener;
    ...
    static void addActionOptionMenu(final Toolbar abcv,
			...
			if (abcv.mSplitView instanceof LewaActionBarContainer) {
				((LewaActionBarContainer) abcv.mSplitView)
				...
				if (abcv.mActionMenuPresenter instanceof LewaActionMenuPresenter) {
					...
					presenter
							.setOnActionMenuUpdateListener(new LewaActionMenuPresenter.OnActionMenuUpdateListener() {
     ...
     * ActionBar API. See
     * {@link lewa.support.v7.app.ActionBarActivity#setSupportActionBar(Toolbar)
