...
import lewa.support.v7.internal.transition.ActionBarTransition;
import lewa.support.v7.internal.view.ActionBarPolicy;
import lewa.support.v7.internal.view.menu.ActionMenuItemView;
import lewa.support.v7.internal.view.menu.BaseMenuPresenter;
...
import lewa.support.v7.internal.widget.TintImageView;
///LEWA BEGIN
...
public class ActionMenuPresenter extends BaseMenuPresenter
    ...
    public ActionMenuPresenter(Context context) {
        ...
        // LEWA ADD BEGIN
        Injector.initLewaStyle(this, context);
        // LEWA ADD END
    }
...
///LEWA ADD BEGIN
    ...
    static class Injector {
        ...
        static void initActionMenuItem(ActionMenuPresenter oThis, MenuItemImpl item, MenuView.ItemView itemView) {
            if (true) {
                if (oThis instanceof LewaActionMenuPresenter) {
                    LewaActionMenuPresenter menuPresenter = (LewaActionMenuPresenter) oThis;
        ...
        static void initLewaStyle(ActionMenuPresenter oThis, Context context) {
            if (true) {
